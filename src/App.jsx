  ...
  return (
    <div className="">
      <main className="">
        ...
        <div className="z-20 w-full px-0 md:px-12 py-6 md:py-8 bg-black text-base md:text-4xl  tracking-[0.5rem] md:tracking-[1.3rem]">
        ...
        <section className="px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 place-items-end pt-12">
            <div className="p-2 md:p-16">
              ...
              <div className="text-xs pt-4">WOOL-SAFE MACHINERY GUARANTEED</div>
            </div>
            <div className="p-2 md:p-16">
            ...
            <div className="p-2 md:p-16">
              ...
              <div className="text-xs pt-4">HOHENSTEIN APPROVED EQUIPMENT</div>
            </div>
            <div className="p-2 md:p-16">
              <img className="w-full aspect-square rounded-2xl" src={expert} />
              <div className="text-xs pt-4">
        ...
        <section style={{ padding: "50px" }}>
          <h2
            className="gradient_text text-left text-xl md:text-6xl font-medium"
            style={
              {
                // textAlign: "left",
                // fontSize: "3.5em",
        ...
        <section className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="p-12 flex flex-col justify-start">
            ...
            <p className="mt-4 text-start">
              ...
              services range from basic laundry to steam ironing, shoe cleaning
              and even dry cleaning. Our commitment to providing high-quality
              services has made us a trusted name in the industry.
            </p>
          </div>
        </section>
        ...
        <section className="p-12 md:p-16 flex flex-col" id="Services">
          ...
          <p className="text-start text-xs mt-2">
            ...
            handled with the utmost care and attention. Whether you need a quick
            refresh or a deep clean, we've got you covered. We believe that our
            customers deserve only the best, and we strive to deliver just that
            with every service we provide. So why wait? Let us take care of your
            laundry needs todav!
            <br />
            <br />
            <br />
            ...
            convenient solution for all vour evervdav clothes. We use the latest
            technology and high-quality detergents to ensure that your clothes
            are cleaned thoroughly and are returned to you fresh and crisp.
            <br />
            <br />
            ...
            technology and high-quality cleaning products to clean your clothes,
            ensuring that they are returned to you in pristine condition.
            <br />
            <br />
            <strong className=" text-lime-500">Steam Ironing:</strong> Our steam
            ironing service is perfect for those who want their clothes to look
            as good as new. Our team of experts use the latest steam ironing
            technology to remove all creases and wrinkles from your clothes,
            leaving them looking freshly pressed.
            <br />
            <br />
            <br />
        ...
        >
          ...
          <div className="text-left border-l-[5px] border-purple-700 flex flex-col p-12 ">
            ...
            <p style={{ fontSize: "0.7em", paddingRight: "50px" }}>
              ...
              equipment, you'll be able to provide top-notch laundry services to
              your community while building a successful business. Our team will
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 text-start">
          <div className="pl-8 pt-8 pb-8 md:py-20 md:pl-20 border-l-4 border-purple-700 flex flex-col">
            ...
            <p className="text-xs pr-4">
              ...
              brand that has been providing quality laundry services for years.
              Our commitment to your success is evident in everything we do,
              from the top-of-the-line equipment and supplies we provide to the
              ongoing support and training we offer.
              <br />
              <br />
              Our franchisees are more than just business partners - they're an
              integral part of our company and our community. We believe in
              fostering a culture of collaboration and support, and we're always
              here to help you with any challenges you may face. Whether you
              need advice on running your business, help with marketing, or
              support with managing your finances, we're here to help.
            </p>
          ...
          <div className="pt-12 flex flex-col justify-around text-start">
            ...
            <div>
              ...
              <div className="flex gap-3 justify-start items-start py-2">
                ...
                >
                  {" "}
                  # 17/388/17, 19th H Road,Ist N Block, Rajajinagar, Bengaluru,
                  Karnataka 560010
                </a>
              </div>
            </div>
